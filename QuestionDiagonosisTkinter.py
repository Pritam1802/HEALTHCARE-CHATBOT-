...
def execute_bot():
    #print("Please press start if the question doesnt appear!")
...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        ...
        self.btnNo=Button(self,text="No",width=12,bg="white", command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=12,bg="white", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=12,bg="white", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=12,bg="white", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Pritam Shastri", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Anugraha Anilkumar", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Uthkarsh Nikhil", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="Apramey MK", bg="RoyalBlue4", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam4.pack()
